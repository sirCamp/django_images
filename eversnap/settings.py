...
SECRET_KEY = 'vux&k!rigi!rex%hw*7fxer#yau&c+lcu#(6!emy9y=0=xvu_w'
...
CRON_CLASSES = [
    "cron.crontabs.RetriveImageCron",
    # ...
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'eversnap.sqlite3'),
    }
}
...
TWITTER_API_KEY='kI84vVSdMIv7G4lQ1zyKLv6AD'
